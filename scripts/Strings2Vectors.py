...
__description__ = 'Produce vectors from list of strings'
...
def read_argv():
	...
	parser.add_argument('-l', '--lemma_dim',
                  action='store_true', dest='lemma_dim', default=True,
